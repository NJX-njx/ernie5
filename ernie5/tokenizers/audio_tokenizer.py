...
class VectorQuantizer1d(nn.Module):
    ...
    def forward(self, latents):
        ...
        return quantized, loss, encoding_indices.view(latents_shape[0], latents_shape[1])
...
class ResidualVectorQuantizer(nn.Module):
    ...
    def forward(self, x, n_layers: int = None):
        ...
        return quantized_out, torch.stack(all_losses).mean(), torch.stack(all_indices, dim=1)
